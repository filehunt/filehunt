...
interface SearchLeftSidebarProps {
  ...
  onSavedSearchesChange: (searches: SearchFilters[]) => void;
}
...
export function SearchLeftSidebar({ filters, onFiltersChange, savedSearches, onSavedSearchesChange }: SearchLeftSidebarProps) {
  ...
  const applySavedSearch = (search: { filters: SearchFilters }) => {
    ...
    <div className="w-[240px] bg-[#292b36] border-r border-[#373a4b] flex flex-col">
      ...
      <div className="p-4 border-b border-[#373a4b]">
        ...
        <div className="flex space-x-1">
          <Input
            ...
            className="bg-[#373a4b] border-[#434656] text-white text-sm h-8"
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              ...
              { key: 'needs-review', label: 'Needs Review', icon: MessageCircle },
              { key: 'needs-retouching', label: 'Needs Retouching', icon: SquareDashedMousePointer }
            ].map(status => (
              ...
              <Badge
                ...
                className={`text-sm cursor-pointer transition-all duration-200 hover:scale-105 ${
                  (filters.tags || []).includes(tag)
                    ...
                    : 'bg-[#373a4b] text-gray-300 hover:bg-[#434656] border border-transparent hover:border-purple-500/20'
                }`}
              ...
              <button
                ...
                className={`w-full text-left text-sm px-3 py-2 rounded-md transition-all duration-200 hover:scale-[1.02] ${
                  (filters.folders || []).includes(folder)
                    ...
                    : 'text-gray-300 hover:bg-[#373a4b] hover:text-white border border-transparent hover:border-orange-500/20'
                }`}
              >
                {folder}
              </button>
        ...
        <div>
          ...
          <Input
            ...
            className="bg-[#373a4b] border-[#434656] text-white text-sm focus:border-cyan-500 focus:ring-cyan-500/20"
          />
        </div>
        ...
        <div>
          ...
          <Select value={filters.sortBy || 'relevance'} onValueChange={(value) => updateFilter('sortBy', value)}>
            <SelectTrigger className="bg-[#373a4b] border-[#434656] text-white text-sm focus:border-cyan-500 focus:ring-cyan-500/20">
              <SelectValue />
            </SelectTrigger>
      ...
      <div className="p-4 border-t border-[#373a4b]">
        <Button
          ...
          className="w-full border-[#434656] text-gray-300 hover:text-white text-sm hover:border-red-500/50 hover:bg-red-500/10 transition-colors duration-200"
        >
          Clear All Filters
        </Button>
      </div>
