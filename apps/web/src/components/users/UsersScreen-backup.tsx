...
export function UsersScreen() {
  ...
  return (
    <div className="h-full relative">
      {/* Main Content */}
      <div className="h-full pr-80"> {/* Space for larger sidebar */}
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  {filteredUsers.map((user, index) => {
                    ...
                    return (
                      <div
                        key={user.id}
                        className={cn(
                          "grid grid-cols-12 gap-4 p-4 hover:bg-muted/20 cursor-pointer transition-colors",
              ...
              <TabsContent value="roles" className="p-6 space-y-6">
                <div className="space-y-4">
                  {mockRoles.map((role, index) => {
                    ...
                    return (
                      <div key={role.id} className="p-6 space-y-4">
                        <div>
              ...
              <TabsContent value="activity" className="p-6 space-y-6">
                <div className="space-y-4">
                  <div className="space-y-4">
                    <div className="mb-4">
                      <h3 className="font-medium text-lg">Recent User Activity</h3>
                      <p className="text-muted-foreground text-sm">Track user actions and login history</p>
                    </div>
                    <div>
                      <div className="space-y-4">
                        {[
      ...
      <div className="fixed right-0 w-80 flex flex-col" style={{ top: '140px', bottom: '0' }}>
